  ...
  return (
    <li className="list-group-item">
      <div className="search-item-container">
        <div onClick={() => onVideoPlay(searchItem.video.id)} className="search-item-thumb">
          <img src={searchItem.video.thumbnail_src} />
        </div>
        <div className="search-item-body">
          <h3 onClick={() => onVideoPlay(searchItem.video.id)} className="search-item-video-title">
          ...
          <div className="search-item-channel-date">
            ...
            <div><FontAwesomeIcon onClick={() => onVideoAddToQueue(searchItem.video.id)} className='videoIcons plusIcon' icon="plus" /></div>
          </div>
        </div>
      </div>
    </li>
